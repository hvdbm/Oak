...
def main(input_path: str, config_file_path: str | None, output_dir: str) -> None:
  ...
  output_dir = os.path.join(output_dir, config.folder_name)
  if not os.path.exists(output_dir): os.makedirs(output_dir)
  
  family_df = Family.from_path(input_path).to_df()

  # Plot evolution
  print("Plotting nationalities evolution chart")
  plot_swarm(
  ...
  # Plot repartition
  if config.charts.sex_repartition.enable:
    print("Plotting sex repartition chart")
    plot_pie(
      family_df["sex"].value_counts(),
      f'Sex repartition',
      os.path.join(output_dir, "sex_repartition.png"),
      config.charts.sex_repartition
    )

  print("Plotting nationalities repartition chart")
  plot_bar(
  ...
  print("Plotting last name repartition chart")
  plot_bar(
  ...
  print("Plotting first name repartition chart")
  plot_bar(
